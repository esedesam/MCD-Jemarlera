---
title: \vspace{5cm} Análisis de una serie temporal. US Energy Generation

author: "Samuel Ortega Mediavilla, Pablo Vicente Martínez y Jesúsa Martínez Leal"
...
library(ggplot2)
library(dplyr)
setwd("C:/CDC-Jemarlera") # TENEIS QUE SETEAR EL WD
```
...
plot(d12insample, xlab = x_label, ylab = y_label,
     main = paste("Serie diferenciada con D = 1:", energy_source_label))
```
...
plot(dd12insample, xlab = x_label, ylab = y_label,
     main = paste("Serie diferenciada con D = 1 y d = 1:", energy_source_label))
```
...
source_energy_model_1s <- sarima(dd12insample,2,1,2,0,1,2,12)
...
source_energy_model_2s <- sarima(dd12insample,1,1,2,0,1,1,12)
...
source_energy_model_3s <- sarima(dd12insample,1,0,2,0,1,1,12)
...
plot(insample, xlab = x_label, ylab = y_label,
     main = paste("Ajuste de ARIMA:", energy_source_label))
...
plot(forecast(source_energy_model,h=12), xlab = x_label, ylab = y_label,
     main = paste("Intervalos de confianza de ARIMA para 2022:", energy_source_label))
...
plot(pred, col="red",xaxt="n", xlab = x_label, ylab = y_label,
     main = paste("Datos y predicción ARIMA para el año 2022:", energy_source_label))
points(outsample,pch=19)
