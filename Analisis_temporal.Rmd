...
Seteamos algunas constantes útiles.

```{r}
x_label <- "Tiempo / años"
y_label <- "Generación de energía / MWh"
```


```{r}
# Cargamos el csv con los datos de avistamientos de ovnis
...
```{r}
sel_energia <- "Wind" # Solar -> "Solar Thermal and Photovoltaic" | "Wind"
switch(sel_energia,
...
energy_source_ts <- ts(data = energy_source_df$gen.MWH, start = c(2001, 01), frequency = 12)
```
